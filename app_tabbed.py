"""
NewGrader - Professional Grading System
Main application with tab-based navigation (no sidebar)
"""
...
from modules.pages import (
    ...
    grade_entry, auto_grade, gradebook, settings
)

# Page configuration
st.set_page_config(
    page_title="NewGrader - Professional Grading System",
    page_icon="📚",
    layout="wide"
)
...
with tabs[0]:
    ...
    <div style="
        ...
        margin-bottom: 2rem;
    ">
        <h2 style="color: #1e3a5f; margin-bottom: 1rem;">Welcome to NewGrader</h2>
    ...
    with col1:
        ...
        <div style="{styles.get_stat_card_style('primary')}">
            <h2 style="margin: 0; font-size: 2.5rem;">{total_classes}</h2>
            <p style="margin: 0.5rem 0 0 0;">Classes</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div style="{styles.get_stat_card_style('info')}">
            ...
            <p style="margin: 0.5rem 0 0 0;">Students</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div style="{styles.get_stat_card_style('warning')}">
            <h2 style="margin: 0; font-size: 2.5rem;">{total_assignments}</h2>
            <p style="margin: 0.5rem 0 0 0;">Assignments</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        ...
        <div style="{styles.get_stat_card_style('success')}">
            <h2 style="margin: 0; font-size: 2.5rem;">{total_grades}</h2>
            <p style="margin: 0.5rem 0 0 0;">Total Grades</p>
        </div>
        """, unsafe_allow_html=True)
